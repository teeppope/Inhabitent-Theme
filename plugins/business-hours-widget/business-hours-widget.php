 ...
 * Inhabitent Business Hours Widget is an organized, maintainable boilerplate for building widgets using WordPress best practices.
 *
 * Lightly forked from the WordPress Widget Boilerplate by @tommcfarlin.
 *
 * @package   Business_Hours_Widget
 * @author    Terra Pope <terraepop@gmail.com>
 * @license   GPL-2.0+
 * @link      http://example.com
 * @copyright 2016 ABD Widget
 *
 * @wordpress-plugin
 * Plugin Name:       Business Hours Widget
 * Plugin URI:        http://example.com
 * Description:       A business hours widget for the Inhabitent Supply Co. Site
 * Version:           1.0.0
 * Author:            Terra Pope
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Add weekly business hours for your store.'
			)
		);
